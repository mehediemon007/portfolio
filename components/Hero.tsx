...
const Hero = () => {
    return (
        <section id='home' className='relative h-auto lg:h-[calc(100vh-65px)] 2xl:h-[calc(100vh-80px)] py-14 md:py-20 lg:py-0'>
            <div className='content__wrapper'>
                ...
                <h1 className='lg:max-w-4xl xl:max-w-[660px] 2xl:max-w-[760px] 3xl:max-w-[900px]'>I&apos;m MH Emon<br/>React and Next Js Developer.</h1>
